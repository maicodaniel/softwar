                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('product.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="price" type="number" step="0.01"  min="0.01" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price') }}" required autocomplete="price" autofocus>
